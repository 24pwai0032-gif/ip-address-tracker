...
public class UserLoginForm extends JFrame {
    ...
    public UserLoginForm() {
        ...
        // Back button
        JButton backBtn = UIUtils.createBackButton("Back to Welcome");
        ...
        // Title
        JLabel title = UIUtils.createTitleLabel("User Login");
        ...
        // Login button
        JButton loginBtn = UIUtils.createButton("Login", UIUtils.SECONDARY_COLOR);
    ...
    private void performLogin() {
        ...
        int userId = AuthService.loginUser(username, password, "user");

        if (userId != -1) {
            dispose();
            new ui.user.UserDashboard(userId);
        } else {
